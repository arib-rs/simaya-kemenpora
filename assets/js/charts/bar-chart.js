(function ($) {
	...
	var suratunit = [
		document.getElementById('suratunit0').value,
		document.getElementById('suratunit1').value,
		document.getElementById('suratunit2').value,
		document.getElementById('suratunit3').value,
		document.getElementById('suratunit4').value,
		document.getElementById('suratunit5').value,
		document.getElementById('suratunit6').value
	];
	...
	var barchart4 = new Chart(ctx, {
		type: 'bar',
		data: {
			labels: [unit[0], unit[1], unit[2], unit[3], unit[4], unit[5], unit[6]],
			datasets: [{
				label: 'Surat Masuk',
				data: [suratunit[0], suratunit[1], suratunit[2], suratunit[3], suratunit[4], suratunit[5], suratunit[6]],
				borderWidth: 1,
				yAxisID: "y-axis-1",
