...
class M_api extends CI_Model
{
    ...
    {
        $p = $this->db->select('u.id as id_user, p.id as id_pegawai, level ,username , nama_lengkap ,j.id_satuan_kerja ,u.id_grup,j.jabatan,p.idplh,g.grup')
            ->from('tb_user as u')
    ...
    public function select_PenerimaDisposisi_API_bak($lvl, $unit, $jabatan, $id_pegawai)
    {
    ...
    public function select_PenerimaDisposisi_API($lvl, $unit, $jabatan, $id_pegawai,$keyword)
    {
    ...
    public function select_PenerimaDisposisi_API_search($lvl, $unit, $jabatan, $id_pegawai)
    {
