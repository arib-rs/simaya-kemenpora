                                        ...
                                        <table id="table"  data-toggle="table" data-pagination="true" data-search="true" data-toolbar="#toolbar" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-show-export="true" data-show-columns="true">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-sortable="true" data-field="pengirim">Pemberi Disposisi</th>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($data as $d) {
                                                    ...
                                                    echo "<td><a href='" . base_url('Disposisi_masuk/detail/') . $d['id_disposisi'] . "'><span class='label label-primary'><i class='fa big-icon fa-eye'></i> Detail Disposisi</i></span>
                                                    </a>";
