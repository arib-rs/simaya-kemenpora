...
<head>
  ...
  <!-- tree viewer CSS
		============================================ -->
  <link rel="stylesheet" href="<?= base_url('assets/'); ?>css/tree-viewer/tree-viewer.css">
  <!-- normalize CSS
		============================================ -->
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#id_satkerr').change(function() {
        var id_satker = $('#id_satkerr').val();
        if (id_satker != '') {
          $.ajax({
            url: "<?php echo base_url('Utilitas/bagan'); ?>",
            method: "POST",
            data: {
              id_satker: id_satker
            },
